...
let admin = User.newAdmin("Rahul Saha", "male", 22)
console.log(admin);

//Create user
console.log("Create user:");
let user1 = admin.newUser("ritik saha","Male",30)
console.log(user1);
let user2 = admin.newUser("vikas ", "male",20)
console.log(user2);
...
// // update user
let updateuser3 = admin.updateUser(3, "fullName", "gaurav")
...
//Create Contact
user1.createContact("ritik Saha contact", "India")
user1.createContact("vikas saha contact", "Australia")
user1.createContact("Gaurav contact", "Srilanka")
...
console.log(user1.createContactInfo(2, "email", "rahul@gmail.com"));
